  ...
  return (
    <section id="contato" className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-gray-900 rounded-[3rem] overflow-hidden flex flex-col lg:flex-row shadow-2xl">
          <div className="lg:w-1/2 p-12 lg:p-20 text-white space-y-10">
            <div>
            ...
            <div className="flex gap-4">
               <a 
                 ...
                 target="_blank" 
                 className="flex items-center gap-2 bg-white/10 px-6 py-3 rounded-xl hover:bg-white/20 transition-all font-bold"
               >
                 <Instagram className="w-5 h-5" /> Instagram
               </a>
               <a 
                 href={`https://wa.me/55${CLINIC_INFO.phone.replace(/\D/g, '')}`}
                 className="flex items-center gap-2 bg-teal-600 px-6 py-3 rounded-xl hover:bg-teal-700 transition-all font-bold"
               >
                 Agendar Agora
               </a>
            </div>
          ...
          <div className="lg:w-1/2 h-[400px] lg:h-auto min-h-[400px] grayscale hover:grayscale-0 transition-all duration-700">
            <iframe 
